...
const MobileFooter = () => {
  ...
  return (
    <div className="mobile-footer py-16 px-3">
    <div className="px-1">
      ...
      color: expanded === 'panel1' ? 'black' : 'gray'}}>
        ...
        >
          ...
          <p className='text-darkgray font-bold text-xs'>SOLUTIONS</p>
        </AccordionSummary>
        <AccordionDetails>
        <ul className='mobile-footer-list footer-list flex-col flex gap-3'>
      ...
      color: expanded === 'panel2' ? 'black' : 'gray'}}>
        ...
        <p className='text-darkgray font-bold text-xs'>TOOLS</p>
        </AccordionSummary>
        <AccordionDetails>
        <ul className='mobile-footer-list footer-list flex-col flex gap-3'>
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} sx={{boxShadow:'none',
        ...
        <p className='text-darkgray font-bold text-xs'>LEARN</p>
        </AccordionSummary>
        <AccordionDetails>
        <ul className='mobile-footer-list footer-list flex-col flex gap-3'>
      ...
      <Accordion expanded={expanded === 'panel4'} onChange={handleChange('panel4')} sx={{boxShadow:'none',
        ...
        <p className='text-darkgray font-bold text-xs'>ABOUT US</p>
        </AccordionSummary>
        <AccordionDetails>
        <ul className='mobile-footer-list footer-list flex-col flex gap-3'>
      ...
      <ul className='footer-list footer-icons flex gap-3 text-backSecondary text-sm pt-10 px-1 '>
          
           <div className="flex flex-wrap gap-3">
          <li  ><Link className='w-max'>Privacy policy</Link></li>
          <li><Link  className='w-max'>Cookie Policy</Link></li>
          <li><Link  className='w-max'>Security </Link></li>
          <li><Link  className='w-max'>Terms of Service </Link></li>
          <li><Link  className='w-max'>Refferal Program</Link></li>
          <li><Link  className='w-max'>Sitemap</Link></li> 
          </div>

          <li className='flex gap-3 justify-end items-center w-full'>
            <Link>
        ...
        <div className="footer-bottom flex flex-col gap-4 pt-20 xs:px-3 px-1">
       <p className='text-xs text-backSecondary'> <span className='font-bold'>Secfi™ 2024 — All rights reserved.</span> <br /> <br /> “Secfi” refers to Secfi, Inc. and its affiliates. Secfi, Inc. is a technology company offering a range of financial products 
       ...
       <p className="text-xs text-backSecondary font-bold">Check the background of Secfi Securities on FINRA’s BrokerCheck.</p>
